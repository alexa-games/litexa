...
sourceFilename = "#{__dirname}/literate-alexa.pegjs"
cacheFilename = "#{__dirname}/literate-alexa.pegjs.cached"
...
module.exports.buildExtendedParser = (projectInfo) ->
  ...
  if enableParserCache
    ...
    mkdirp.sync tempdir
    projectSourceCacheFilename = path.join tempdir, 'extended-literate-alexa.pegjs'
    projectCodeCacheFilename = path.join tempdir, 'extended-literate-alexa.pegjs.cached'
    try
