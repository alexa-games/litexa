...
/*
Adds a sound file to the next response. The sound should
be specified in the [Asset Name] format, and should
refer to an mp3 file, or a file that can be converted to
mp3 by any installed [Asset Plugin]s
*/
...
:::warning Using launch in the middle of a skill session
Litexa does not prevent you from using `launch` in the
...
:::warning Comparison and assignment on the same variable
