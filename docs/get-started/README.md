...
* `litexa.js` is your project configuration file.
...
@[code lang=javascript transclude={5-12}](@/packages/litexa/src/command-line/templates/common/javascript/litexa.js)
